...
exports.default = {
    ...
    PFED: {
        ENABLED: (ENV !== 'LOCAL' && !process.env.PING__DISABLED) ||
        ...
        CERT_BASE64: process.env.PING__CERT_BASE64 || config_utilities_1.getSecret('PING__CERT_BASE64'),
        LOGOUT_URL: process.env.PING__LOGOUT_URL || appConfig.PING__LOGOUT_URL,
    },
    ICA: {
        ENABLED: true,
        AUTH_TOKEN: process.env.ICA_AUTH_TOKEN || config_utilities_1.getSecret('ICA_AUTH_TOKEN'),
        SECRET: process.env.ICA_AUTH_TOKEN_SECRET || config_utilities_1.getSecret('ICA_AUTH_TOKEN_SECRET'),
        SALT: process.env.ICA_AUTH_TOKEN_SALT || config_utilities_1.getSecret('ICA_AUTH_TOKEN_SALT'),
    ...
    IAM: {
        ...
        SVC_ACCOUNT_PVT_KEY: process.env.IAM_SVC_ACCOUNT_PVT_KEY || config_utilities_1.getSecret('IAM_SVC_ACCOUNT_PVT_KEY'),
        LOGOUT_URL: process.env.IAM__LOGOUT_URL || appConfig.IAM__LOGOUT_URL,
    },
    ROLEACCESS: {
        SUPERADMIN_AD_GROUP: process.env.ROLE_SUPERADMIN_AD_GROUP || appConfig.ROLE_SUPERADMIN_AD_GROUP,
    },
};
